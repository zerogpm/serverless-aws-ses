...
*  Install on serverless framework on your machine
...
See the [open issues](https://github.com/zerogpm/serverless-aws-sms/issues) for a full list of proposed features (and known issues).
